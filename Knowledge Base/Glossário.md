...
Um agente pode se definir como `Online`, `Busy`, `Offline` por meio de suas configurações de perfil.
...
No painel, o  Channel 360 alerta sobre novos eventos (como novas mensagens e conversas) reproduzindo um tom de alerta. Você pode personalizar suas preferências nas configurações do perfil.
...
- Contínuo: Para enviar mensagens de saída no chat ao vivo do site com base em condições, como: se um usuário visitou a página de preços e permaneceu por 3 minutos, envie uma mensagem oferecendo conselhos.
- Único: Para envio de uma campanha SMS para um grupo de contatos.
...
Você pode adicionar contatos manualmente à sua lista de contatos no  Channel 360 enviando um arquivo CSV. Você pode incluir detalhes de contato padrão e personalizados em seu arquivo CSV.
...
Existem quatro tipos de notificações no  Channel 360 áudio, e-mail, push e Slack. Você pode personalizar suas preferências nas configurações do perfil e configurar a integração com o Slack.
...
Existem sete relatórios no  Channel 360, cada um fornecendo uma visão geral de determinadas análises associadas à sua conta.
...
Simple Mail Transfer Protocol (SMTP) é uma configuração que permite enviar mensagens do  Channel 360 através de sua caixa de entrada de e-mail. Habilite esta opção nas configurações do canal de e-mail.
